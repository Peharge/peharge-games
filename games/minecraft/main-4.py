...
def generate_block_column(x, z):
    ...
    if rock_noise > 0.6:
        ...
        stone_variants = ["stone", "stone04", "stone07"]
...
window.borderless = True        # Kein Fensterrand
window.size = window.fullscreen_size  # Automatisch Bildschirmgröße setzen (falls nicht fullscreen)
window.exit_button.visible = False    # Beende-Button oben rechts ausblenden (optional)
app.run()
